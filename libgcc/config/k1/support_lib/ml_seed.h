...
float ml_binary32_invseed_2pm7(float x) {
    ml_uint32_t ux = float_to_32b_encoding(x);
    ml_uint32_t field_7msb = (ux >> (23-7)) & 0x7f;
    ml_uint32_t sign = ux & 0x8000000u;
    //ml_uint32_t exp = -(((ux >> 23) & 0xff) - 127) + 127;
    ml_uint32_t exp = -((ux >> 23) & 0xff) + 254;

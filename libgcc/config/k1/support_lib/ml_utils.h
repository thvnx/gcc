...
/** cast from a binary32 float to its ml_uint32_t binary encoding */
//ml_uint32_t float_to_32b_encoding(float v);
static inline ml_uint32_t float_to_32b_encoding(float v) {
    uif_conv_t conv_tmp;
    conv_tmp.f = v;
    return conv_tmp.u;
}
...
//float float_from_32b_encoding(ml_uint32_t v);
static inline float float_from_32b_encoding(ml_uint32_t v) {
    uif_conv_t conv_tmp;
    conv_tmp.u = v;
    return conv_tmp.f;
}
...
static inline ml_uint64_t double_to_64b_encoding(double v) {
    uid_conv_t conv_tmp;
    conv_tmp.d = v;
    return conv_tmp.u;
}

static inline double double_from_64b_encoding(ml_uint64_t v) {
    uid_conv_t conv_tmp;
    conv_tmp.u = v;
    return conv_tmp.d;
}
...
#define ml_exp_insertion_fp64(k) (double_from_64b_encoding(((ml_uint64_t) (k + 1023) << 52) & 0x7ff0000000000000ull))

#define ml_exp_insertion_no_offset_fp32(k) (float_from_32b_encoding(((k) << 23)))
#define ml_exp_insertion_no_offset_fp64(k) (double_from_64b_encoding(((ml_uint64_t) (k) << 52)))

#define ml_sign_exp_insertion_fp64(aligned_sign, k) (double_from_64b_encoding((((ml_uint64_t) (k + 1023) << 52) & 0x7ff0000000000000ull)| (aligned_sign)))

...
(define_insn "*lo_multiple_cached"
  ...
  "!(REGNO(operands[2]) & 0x3) && !k1_is_uncached_mem_op(SET_SRC(XVECEXP (operands[0], 0, 1)))"
  "lo %O2 = 0[%1]"
  [(set_attr "type" "lsu_load")
   (set_attr "length" "4")])
...
(define_insn "*so_multiple_cached"
  ...
  "!(REGNO(operands[2]) & 0x3) && !k1_is_uncached_mem_op(SET_DEST(XVECEXP (operands[0], 0, 1)))"
  "so 0[%1] = %O2"
  [(set_attr "type" "lsu_store")
   (set_attr "length" "4")])
...
(define_insn "*icall_<mode>"
  [(parallel [(call (mem:P (match_operand:P 0 "register_operand" "r"))
		    (match_operand 1 "general_operand" ""))
	      (clobber (reg:DI RA_REGNO))])]
  "<MODE>mode != DImode || (!TARGET_32)"
  "icall %0"
[(set_attr "type" "bcu")
 (set_attr "class" "link")]
...
(define_insn "real_call"
  [(parallel [(call (match_operand 0 "jump_operand" "")
		    (match_operand 1 "general_operand" ""))
	      (clobber (reg:DI RA_REGNO))])]
  "!K1_FARCALL"
  "call %0"
  ...
  ""
{
  ...
  if (!jump_operand (operands[0], Pmode) || K1_FARCALL)
  ...
  ""
{
  ...
  if (!jump_operand (operands[1], Pmode) || K1_FARCALL)

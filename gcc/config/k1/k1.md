...
(define_insn "*addsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	(plus:SI (match_operand:SI 1 "register_operand" "r,r,r")
		 (match_operand:SI 2 "nonmemory_operand" "r,I10,D37")))]
  ""
  "addw %0 = %1, %2"
...
(define_insn "*addsi3_zext"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
        (zero_extend:DI
             (plus:SI (match_operand:SI 1 "register_operand" "r,r,r")
	              (match_operand:SI 2 "register_operand" "r,I10,D37"))))]
  ""
  "addw %0 = %1, %2"
[(set_attr "type" "lite,lite,lite_x")
 (set_attr "length" "4,4,8")])
...
(define_insn "subsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	(minus:SI (match_operand:SI 1 "register_signed10_37_operand" "r,I10,D37")
  ...
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
        (zero_extend:DI
             (minus:SI (match_operand:SI 1 "register_operand" "r,r,r")
	               (match_operand:SI 2 "register_signed10_37_operand" "r,I10,D37"))))]
  ""
  "sbfw %0 = %1, %2"
[(set_attr "type" "lite,lite_x,lite_y")
 (set_attr "length" "4,8,12")])
...
(define_insn "subdi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(minus:DI (match_operand:DI 1 "nonmemory_operand" "r,I10,D37,i")
...
(define_expand "mulsidi3"
  [(set (match_operand:DI 0 "register_operand" )
	(mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand"))
		 (match_operand:SI 2 "register_signed10_37_operand" )))]
""
{
...
(define_insn "*mulsidi3_imm"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
	(mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" "r,r,r"))
		 (match_operand:SI 2 "immediate_operand" "I10,D37,s")))]
  ""
  "mulwd %0 = %1, %2"
...
(define_insn "*maddsidi4_immediate"
  [(set (match_operand:DI 0 "register_operand" "=r,=r")
        (plus:DI (mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" "r,r"))
                          (match_operand:SI 2 "immediate_operand" "I10,D37"))
...
(define_insn "msubsidi4"
  [(set (match_operand:DI 0 "register_operand" "=r,r,")
        (minus:DI (match_operand:DI 3 "register_operand" "0,0,0")
                  (mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" "r,r,r"))
                           (sign_extend:DI (match_operand:SI 2 "nonmemory_operand" "r,I10,D37")))))]
""
"msbwd %0 = %1, %2"
...
(define_insn "anddi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(and:DI (match_operand:DI 1 "register_operand" "r,r,r,r")
	        (match_operand:DI 2 "register_operand" "r,I10,D37,i")))]
""
"andd %0 = %1, %2"
[(set_attr "type" "tiny,tiny,tiny_x,tiny_y")
 (set_attr "length" "4,4,8,12")])
...
(define_insn "nandw"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
        (ior:SI (not:SI (match_operand:SI 1 "register_operand" "r,r,r"))
                (not:SI (match_operand:SI 2 "register_signed10_37_operand" "r,I10,D37"))))]
  ""
  "nandw %0 = %1, %2"
[(set_attr "type" "lite,lite,lite_x")
 (set_attr "length" "4,4,8")]
...
(define_insn "set<mode>_volatile"
...
(define_insn "set<mode>_ps_volatile"
   [(set (match_operand:ALLP 0 "system_register_operand" "=RXX")
...
(define_insn "get<mode>_volatile"
...
(define_expand "acws"
  [(parallel
    [(set (match_operand:TI 0 "register_operand" "=r,=r")
          (unspec:TI [(match_operand:DI 1 "memory_operand" "+a,+m")] UNSPEC_ACWS))
     (set (match_dup 1)
          (unspec:DI
           [(match_dup 1)
            (match_operand:TI 2 "register_operand" "0,0")]
           UNSPEC_ACWS))])]
   ""
   {}
)
...
(define_insn "*l<mode><su>"
   ...
   "!K1_FORCE_UNCACHED_LSU"
   "l<ALL_SMALL_I:lsusize><su>%m1 %0 = %1"
[(set_attr "length" "4,8")
 (set_attr "type" "lsu_load,lsu_load_x")]
)
...
(define_insn "extend<mode>di2"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(sign_extend:DI (match_operand:ALL_SMALL_I 1 "register_operand" "r")))]
  ""
  "sx<lsusize>d %0 = %1"
  [(set_attr "type" "lite")
   (set_attr "length" "4")])
...
(define_insn "zero_extend<mode>di2"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(zero_extend:DI (match_operand:ALL_SMALL_I 1 "register_operand" "r")))]
  ""
  "zx<lsusize>d %0 = %1"
  [(set_attr "type" "lite")
   (set_attr "length" "4")])
...
(define_insn "sbmm8"
  ...
  "sbmm8 %0 = %1, %2"
  [(set_attr "type" "lite") ;; ,alud_y,alud_z
  ...
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
        (match_operator:DI 1 "comparison_operator"
	        [(match_operand:DI 2 "register_operand" "r,r,r")
	         (match_operand:DI 3 "register_signed10_37_operand" "r,I10,D37")]))]
""
"compd.%1 %0 = %2, %3"
[(set_attr "type" "tiny,tiny,tiny_x")
 (set_attr "length" "4,4,8")])
...
(define_insn "*comp_<mask_name>" 
  [(set (match_operand:SI 0 "register_operand" "=r,=r,=r")
        (mask_cond:SI (and:SI (match_operand:SI 1 "register_operand" "r,r,r")
	                      (match_operand:SI 2 "register_signed10_37_operand" "U10,D37,r"))
	              (match_dup 2)))]
  ""
...
(define_insn "*cwmoved_even_eq<mode>"
...
(define_insn "*cwmoved_even_ne<mode>"
  [(set (match_operand:SISIZESCALAR 0 "register_operand" "=r")
...
(define_insn "*cwmoved_odd_eq<mode>"
  [(set (match_operand:SISIZESCALAR 0 "register_operand" "=r")
	(if_then_else:SISIZESCALAR (eq
                          (zero_extract (match_operand:SI 1 "register_operand" "r")
			  		(const_int 1) (const_int 0))
...
(define_insn "*cwmoved_odd_ne<mode>"
  [(set (match_operand:SISIZESCALAR 0 "register_operand" "=r")
	(if_then_else:SISIZESCALAR (ne
                          (zero_extract (match_operand:SI 1 "register_operand" "r")
			  		(const_int 1) (const_int 0))
  ...
  ""
{
	...
	// c*b only compares to 0
	if ( (!(CONST_INT_P(operands[2]) && (INTVAL(operands[2]) == 0)))){
	   rtx reg = gen_reg_rtx (<MODE>mode);

	   /* cwmoved does not take immediate yet */
	   /* FIXME AUTO: condw. workaround for lack of imx */
	   /* cdb only takes up to 37 signed immediate. */
	   if (<MODE>mode == SImode
	       || ( !satisfies_constraint_I10(operands[2]) && !satisfies_constraint_D37(operands[2])))
...
(define_insn "abd"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	(abs:SI (minus:SI  (match_operand:SI 2 "register_signed10_37_operand" "r,I10,D37")
	                   (match_operand:SI 1 "register_operand" "r,r,r"))))]
  ""
  "abdw %0 = %1, %2"
  [(set_attr "type" "lite,lite,lite_x")

...
(define_insn "*lo_multiple_cached"
  ...
  "lo %O1 = %3[%2]"
  [(set_attr "type" "lsu_load_auxw,lsu_load_auxw_x,lsu_load_auxw_y")
...
(define_insn "*lo_multiple_uncached"
  ...
  "(XVECLEN (operands[0], 0) == 4)"
  "lo.u %O1 = %3[%2]"
  [(set_attr "type" "lsu_load_auxw_uncached, lsu_load_auxw_uncached_x, lsu_load_auxw_uncached_y")
   (set_attr "length" "4,8,12")])
...
[(set_attr "type"    "mau, lsu_load_auxw, lsu_load_auxw_x, lsu_load_auxw_uncached, lsu_load_auxw_uncached_x, lsu_store_auxr, lsu_store_auxr_x")
...
[(set_attr "type"    "lsu_auxr_auxw, lsu_load_auxw, lsu_load_auxw_x, lsu_load_auxw_uncached, lsu_load_auxw_uncached_x, lsu_store_auxr, lsu_store_auxr_x")
 (set_attr "length"  "            4,              4,              8,                      4,                        8,              4,                8")])
...
[(set_attr "type"    "tiny, tiny, tiny_x, tiny_y, lsu_store, lsu_store_x, lsu_load<auxw>, lsu_load<auxw>_x, lsu_load<auxw>_uncached, lsu_load<auxw>_uncached_x, bcu_get, all, tiny<symlen1>")
...
(define_insn "finvw"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FINVW))]
  ""
  "finvw %0 = %1"
  [(set_attr "type" "alu")]
)
...
(define_insn "fisrw"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FISRW))]
  ""
  "fisrw %0 = %1"
  [(set_attr "type" "alu")]
)

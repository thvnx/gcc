...
[(set_attr "type"    "alu_tiny, alu_tiny, alu_tiny_x, alu_tiny_y, lsu_auxr_store, lsu_auxr_store_x, lsu_auxw_load, lsu_auxw_load_x, lsu_auxw_load_uncached, lsu_auxw_load_uncached_x, bcu_get, all, alu_tiny<symlen1>")
...
(define_expand "k1_ffmadc"
  [(set (match_operand:DC 0 "register_operand" "=r")
        (unspec:DC [(match_operand:DC 1 "register_operand" "0")
                    (match_operand:DC 2 "register_operand" "r")
                    (match_operand:DC 3 "register_operand" "r")
...
(define_insn "avgsi3_floor"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
        (ashiftrt:SI (plus:SI (match_operand:SI 1 "register_operand" "r,r,r")
                              (match_operand:SI 2 "register_s32_operand" "r,I10,I32"))
                     (const_int 1)))]
  ""
  "avgw %0 = %1, %2"
...
(define_insn "uavgsi3_floor"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
        (lshiftrt:SI (plus:SI (match_operand:SI 1 "register_operand" "r,r,r")
                              (match_operand:SI 2 "register_s32_operand" "r,I10,I32"))
                     (const_int 1)))]
  ""
  "avguw %0 = %1, %2"

...
(define_insn "*mov_quad"
    [(set (match_operand:TI 0 "nonimmediate_operand" "=r, r,   r,  r,  r,  a, m")
          (match_operand:TI 1 "nonimmediate_operand" " r, Ca, Cm, Za, Zm, r, r" ))]
...
[(set_attr "type"    "mau, lsu_auxw_load, lsu_auxw_load_x, lsu_auxw_load_uncached, lsu_auxw_load_uncached_x, lsu_auxr_store, lsu_auxr_store_x")
 (set_attr "length"  "4,               4,               8,                      4,                        8,              4,                8")])

(define_insn "*mov_octuple"
    [(set (match_operand:OI 0 "nonimmediate_operand" "=r, r,   r,  r,  r,  a, m")
          (match_operand:OI 1 "nonimmediate_operand" " r, Ca, Cm, Za, Zm, r, r"))]
  "REG_P (operands[0]) || REG_P (operands[1])"
{
  switch (which_alternative)
    {
...
[(set_attr "type"    "lsu_auxr_auxw, lsu_auxw_load, lsu_auxw_load_x, lsu_auxw_load_uncached, lsu_auxw_load_uncached_x, lsu_auxr_store, lsu_auxr_store_x")
 (set_attr "length"  "            4,              4,              8,                      4,                        8,              4,                8")])


;; FIXME AUTO: refine set insn to bundle it when possible. T7808
(define_insn "*mov<mode>_all"
    [(set (match_operand:ALLIF 0 "nonimmediate_operand" "=r, r,           r,  r, a, m, r , r , r , r , r,  RXX, r, r")
          (match_operand:ALLIF 1 "general_operand"      " r, I16H16, I43H43, nF, r, r, Ca, Cm, Za, Zm, RXX,  r, T, S"))]
...
[(set_attr "type"    "alu_tiny, alu_tiny, alu_tiny_x, alu_tiny_y, lsu_auxr_store, lsu_auxr_store_x, lsu_auxw_load, lsu_auxw_load_y, lsu_auxw_load_uncached, lsu_auxw_load_uncached_y, bcu_get, all,  alu_full_x, alu_tiny<symlen1>")
 (set_attr "length"  "4,        4,        8,          12,         4,              8,                4,             12,              4,                      12,                       4,       4,    8,          <symlen2>")
 (set (attr "disabled")
      (cond [(and (eq_attr "alternative" "13")
                  (match_test "<MODE>mode != Pmode")) (const_string "yes")
	     (and (eq_attr "alternative" "12")
...
(define_insn "ldu"
   ...
   "ld.u%m1 %0 = %1"
[(set_attr "length" "4,8")
 (set_attr "type" "lsu_auxw_load_uncached,lsu_auxw_load_uncached_x")]
)
...
[(set_attr "length" "4,8,4,8")
 (set_attr "type" "lsu_auxw_load,lsu_auxw_load_x,lsu_auxw_load_uncached,lsu_auxw_load_uncached_x")]
)
...
(define_insn "extend<mode>di2"
  ...
  l<lsusize>s%m1.u %0 = %1"
  [(set_attr "type" "alu_lite,lsu_auxw_load,lsu_auxw_load_x,lsu_auxw_load_uncached,lsu_auxw_load_uncached_x")
   (set_attr "length" "4,4,8,4,8")])
...
(define_insn "sssubsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
        (ss_minus:SI (match_operand:SI 1 "register_operand" "r,r,r")
                     (match_operand:SI 2 "register_s32_operand" "r,I10,I32")))]
  ""
  "sbfsw %0 = %1, %2"
  [(set_attr "type" "alu_lite,alu_lite,alu_lite_x")
...
(define_insn "*sssubsi3_zext"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
        (zero_extend:DI (ss_minus:SI (match_operand:SI 1 "register_operand" "r,r,r")
                                     (match_operand:SI 2 "register_s32_operand" "r,I10,I32"))))]
  ""
  "sbfsw %0 = %1, %2"
  [(set_attr "type" "alu_lite,alu_lite,alu_lite_x")
...
(define_insn "sssubdi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
        (ss_minus:DI (match_operand:DI 1 "register_operand" "r,r,r,r")
                     (match_operand:DI 2 "k1_alu_op3_operand" "r,I10,B37,i")))]
  ""
  "sbfsd %0 = %1, %2"
  [(set_attr "type" "alu_lite,alu_lite,alu_lite_x,alu_lite_y")
...
(define_expand "k1_fmuldc"
  ...
  ""
  {
    ...
    emit_insn (gen_k1_ffmsd (real_0, real_t, imag_1, imag_2, operands[3]));
    emit_insn (gen_k1_fmuld (imag_t, real_1, imag_2, operands[3]));
    emit_insn (gen_k1_ffmad (imag_0, imag_t, real_2, imag_1, operands[3]));
    DONE;
  }
)
...
(define_expand "k1_ffmawc"
  [(set (match_operand:SC 0 "register_operand" "=r")
        (unspec:SC [(match_operand:SC 1 "register_operand" "0")
                    (match_operand:SC 2 "register_operand" "r")
                    (match_operand:SC 3 "register_operand" "r")
                    (match_operand 4 "" "")] UNSPEC_FFMAWC))]
  ""
  {
    rtx prod = gen_reg_rtx (SCmode);
    emit_insn (gen_k1_fmulwc (prod, operands[2], operands[3], operands[4]));
    emit_insn (gen_k1_faddwc (operands[0], operands[1], prod, operands[4]));
    DONE;
  }
)
...
(define_expand "k1_ffmadc"
  ...
  ""
  {
    ...
    rtx real_2 = gen_rtx_SUBREG (DFmode, operands[2], 0);
    rtx imag_2 = gen_rtx_SUBREG (DFmode, operands[2], 8);
    rtx real_3 = gen_rtx_SUBREG (DFmode, operands[3], 0);
    rtx imag_3 = gen_rtx_SUBREG (DFmode, operands[3], 8);
    rtx real_t = gen_reg_rtx (DFmode), imag_t = gen_reg_rtx (DFmode);
    emit_insn (gen_k1_fmuld (real_t, real_2, real_3, operands[4]));
    emit_insn (gen_k1_ffmsd (real_p, real_t, imag_2, imag_3, operands[4]));
    emit_insn (gen_k1_fmuld (imag_t, real_2, imag_3, operands[4]));
    emit_insn (gen_k1_ffmad (imag_p, imag_t, real_3, imag_2, operands[4]));
    emit_insn (gen_k1_fadddc (operands[0], operands[1], prod, operands[4]));
    DONE;
  }
)
...
(define_expand "k1_ffmswc"
  ...
  ""
  {
    rtx prod = gen_reg_rtx (SCmode);
    emit_insn (gen_k1_fmulwc (prod, operands[2], operands[3], operands[4]));
    emit_insn (gen_k1_fsbfwc (operands[0], prod, operands[1], operands[4]));
    DONE;
  }
)
...
(define_expand "k1_ffmsdc"
  ...
  ""
  {
    ...
    emit_insn (gen_k1_fmuld (imag_t, real_2, imag_3, operands[4]));
    emit_insn (gen_k1_ffmad (imag_p, imag_t, real_3, imag_2, operands[4]));
    emit_insn (gen_k1_fsbfdc (operands[0], prod, operands[1], operands[4]));
    DONE;
  }
)

...
(define_insn_and_split "*xordi3_k1a"
  [(set (match_operand:DI 0 "register_operand" "=r,=r,=r,=r")
...
{
    if (k1_architecture() >= K1B)
       emit_insn(gen_absdi2_k1b(operands[0], operands[1]));
    else
       emit_insn(gen_absdi2_k1a(operands[0], operands[1]));
    DONE;
})

(define_insn "absdi2_k1a"
  [(set (match_operand:DI            0 "register_operand" "=r")
	(abs:DI (match_operand:DI 1 "register_operand" "r")))]
  "k1_architecture() < K1B"
  "absd %d0 = %d1"
...
(define_expand "clzdl"
  [(set (match_operand:SI         0 "register_operand")
	(clz:SI (match_operand:DI 1 "register_operand")))]
""
{})

(define_insn "*clzdl_k1b"
  [(set (match_operand:SI         0 "register_operand" "=r")
...
(define_expand "ctzdl"
  [(set (match_operand:SI         0 "register_operand")
	(subreg:SI (ctz:DI (match_operand:DI 1 "register_operand")) 0))]
""
{})

(define_insn "*ctzdl_k1b"
  [(set (match_operand:SI         0 "register_operand" "=r")
...
(define_insn "dpurge"
   [(unspec [(const_int 0)] UNSPEC_DPURGE)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 0 "" "") 
         (unspec:SI [(match_dup 0)] UNSPEC_SYNC))]
   "k1_architecture() < K1B"
...
(define_insn "dpurgel"
   [(unspec_volatile [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_DPURGEL)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 1 "" "") 
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   "k1_architecture() < K1B"
...
(define_insn "dinvall"
   [(unspec [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_DINVALL)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 1 "" "")
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   ""
...
(define_insn "iinvall"
   [(unspec_volatile [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_IINVALL)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 1 "" "") 
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   ""
...
(define_insn "itouchl"
   [(unspec_volatile [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_ITOUCHL)
    (set (match_operand:SI 1 "" "") 
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   ""
   "itouchl%m0 %0"
...
(define_insn "dtouchl_<mode>"
  [(prefetch (match_operand:P 0 "non_modulo_address_operand" "A,p")
             (match_operand:SI 1 "" "")
             (match_operand:SI 2 "" ""))]
   ""
   "dtouchl%m0 %a0"
...
(define_insn "dzerol"
   [(unspec [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_DZEROL)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 1 "" "") 
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   ""
...
(define_insn "dflushl"
   [(unspec_volatile [(match_operand:SI 0 "non_modulo_memory_operand" "a,m")] UNSPEC_DFLUSHL)
    (set (match_operand:SI 1 "" "") 
         (unspec:SI [(match_dup 1)] UNSPEC_SYNC))]
   "k1_architecture() < K1B"
   "dflushl%m0 %0"
...
(define_insn "dflush"
   [(unspec_volatile [(const_int 0)] UNSPEC_DFLUSH)
    (set (match_operand:SI 0 "" "") 
         (unspec:SI [(match_dup 0)] UNSPEC_SYNC))]
   "k1_architecture() < K1B"
   "dflush"
...
(define_insn "indexjtlb"
   [(unspec_volatile [(const_int 0)] UNSPEC_INDEXJTLB)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 0 "" "") 
         (unspec:SI [(match_dup 0)] UNSPEC_SYNC))]
   ""
...
(define_insn "indexltlb"
   [(unspec_volatile [(const_int 0)] UNSPEC_INDEXLTLB)
    (clobber (mem:BLK (scratch)))
    (set (match_operand:SI 0 "" "") 
         (unspec:SI [(match_dup 0)] UNSPEC_SYNC))]
   ""
...
(define_insn "ldc"
   [(set (match_operand:DI 0 "register_operand" "=r,=r")
         (unspec_volatile:DI [(match_operand:DI 1 "non_modulo_memory_operand" "a,m")] 
          UNSPEC_LDC))]
   ""
   "aldcu%m1 %0 = %1"
[(set_attr "length" "4,8")
...
(define_expand "acws"
  [(parallel
    [(set (match_operand:DI 0 "register_operand" "=r,=r")
          (unspec:DI [(match_operand:SI 1 "non_modulo_memory_operand" "+a,+m")] UNSPEC_ACWS))
     (set (match_dup 1)
          (unspec:SI
           [(match_dup 1)
...
(define_insn "*acws"
    [(set (match_operand:DI 1 "register_operand" "+r,+r")
          (unspec:DI [(match_operand:SI 0 "non_modulo_memory_operand" "+a,+m")] UNSPEC_ACWS))
     (set (match_dup 0)
          (unspec:SI
           [(match_dup 0)
            (match_dup 1)]
...
(define_expand "cws"
  [(parallel
    [(set (match_operand:DI 0 "register_operand" "=r,=r")
          (unspec:DI [(match_operand:SI 1 "non_modulo_memory_operand" "+a,+m")] UNSPEC_CWS))
     (set (match_dup 1)
          (unspec:SI
           [(match_dup 1)
            (match_operand:DI 2 "register_operand" "0,0")]
...
(define_insn "*cws"
    [(set (match_operand:DI 1 "register_operand" "+r,+r")
          (unspec:DI [(match_operand:SI 0 "non_modulo_memory_operand" "+a,+m")] UNSPEC_CWS))
     (set (match_dup 0)
          (unspec:SI
           [(match_dup 0)
            (match_dup 1)]
...
(define_expand "stsud"
  [(set (match_operand:DI 0 "register_operand" )
	(unspec:DI [(match_operand:DI 1 "register_operand" )
		    (match_operand:DI 2 "register_operand" )] UNSPEC_STSUD))])

(define_insn "*stsud_k1b"
  [(set (match_operand:DI 0 "register_operand" "=r")
...
(define_insn_and_split "sbmm8"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r,r,r")
		    (match_operand:DI 2 "nonmemory_operand" "r,D37,i")] UNSPEC_SBMM8))]
  "REG_P(operands[2]) || current_pass->tv_id != TV_CPROP"
  "sbmm8 %d0 = %d1, %d2"
  "k1_architecture() < K1B && !reload_completed"
  [(parallel [(set (match_dup 3)
  	     	   (subreg:SI (unspec:DI [(concat (match_dup 5)
  		   	      		  	  (match_dup 6))
					  (concat (match_dup 7)
					  	  (match_dup 8))] UNSPEC_SBMM8) 0))
	       (set (match_dup 4)
  	     	   (subreg:SI (unspec:DI [(concat (match_dup 5)
  		   	      		  	  (match_dup 6))
					  (concat (match_dup 7)
					  	  (match_dup 8))] UNSPEC_SBMM8) 4))])]
{
       if (!reg_mentioned_p (operands[0], operands[1])
           && !reg_mentioned_p (operands[0], operands[2]))
          emit_clobber (operands[0]);
	...
	operands[6] = gen_highpart (SImode, operands[1]);
	if (GET_CODE (operands[2]) == CONST_DOUBLE) {
		operands[7] = gen_rtx_CONST_INT (VOIDmode, CONST_DOUBLE_LOW (operands[2]));
		operands[8] = gen_rtx_CONST_INT (VOIDmode, CONST_DOUBLE_HIGH (operands[2]));
	} else if (GET_CODE (operands[2]) == CONST_INT) {
	       	long long val = INTVAL (operands[2]);
		operands[7] = gen_rtx_CONST_INT (VOIDmode, 
			      			 ((val & 0xFFFFFFFFLL) << 32) >> 32);
		operands[8] = gen_rtx_CONST_INT (VOIDmode, val >> 32);
	} else {
		operands[7] = gen_lowpart (SImode, operands[2]);
		operands[8] = gen_highpart (SImode, operands[2]);
...
(define_expand "sbmmt8"
  [(set (match_operand:DI 0 "register_operand")
	(unspec:DI [(match_operand:DI 1 "register_operand")
		    (match_operand:DI 2 "nonmemory_operand" )] UNSPEC_SBMMT8))])

(define_insn "*sbmmt8_k1b"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r")
		    (match_operand:DI 2 "nonmemory_operand" "r")] UNSPEC_SBMMT8))]
"k1_architecture() >= K1B"
"sbmmt8 %0 = %1, %2"
[(set_attr "type" "alud_lite")
 (set_attr "length" "4")])
...
(define_insn_and_split "*sbmmt8_k1a"
  [(set (match_operand:DI 0 "register_operand" "=r,=r,=r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r,r,r")
		    (match_operand:DI 2 "nonmemory_operand" "r,D37,i")] UNSPEC_SBMMT8))]
  "REG_P(operands[2]) || current_pass->tv_id != TV_CPROP"
  "sbmmt8 %d0 = %d1, %d2"
  "k1_architecture() < K1B && !reload_completed"
  [(parallel [(set (match_dup 3)
  	     	   (subreg:SI (unspec:DI [(concat (match_dup 5)
  		   	      		  	  (match_dup 6))
					  (concat (match_dup 7)
					  	  (match_dup 8))] UNSPEC_SBMMT8) 0))
	       (set (match_dup 4)
  	     	   (subreg:SI (unspec:DI [(concat (match_dup 5)
  		   	      		  	  (match_dup 6))
					  (concat (match_dup 7)
					  	  (match_dup 8))] UNSPEC_SBMMT8) 4))])]
{
       if (!reg_mentioned_p (operands[0], operands[1])
           && !reg_mentioned_p (operands[0], operands[2]))
          emit_clobber (operands[0]);
...
(define_expand "bwluwp"
  [(set (match_operand:DI 0 "register_operand")
	(unspec:DI [(match_operand:DI 1 "register_operand")
		    (match_operand:DI 2 "register_operand")
		    (match_operand 3 "immediate_operand")] UNSPEC_BWLUWP))])

(define_insn "*bwluwp_k1b"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r")
		    (match_operand:DI 2 "register_operand" "r")
...
(define_insn "c<SIDI_cond_arch:cbvar>b<code>"
  [(set (pc)
	(if_then_else (cb_cond  
		        (match_operand:SIDI_cond_arch 0 "register_operand" "r")
		        (const_int 0))
		      (match_operand 1 "immediate_operand" "i")
		      (pc)))]
  ""
  "c<SIDI_cond_arch:cbvar>b.<code>z %0, %1"
[(set_attr "type" "bcu")]
)
...
(define_insn "*cstoredi4_common"
  [(set (match_operand:SI 1 "register_operand" "=r,r,r,r")
        (match_operator:SI 0 "comparison_operator"
	        [(match_operand:DI 2 "register_operand" "r,r,r,r")
	         (match_operand:DI 3 "nonmemory_operand" "r,I10,D37,n")]))]
 ""
{
    switch (which_alternative) {
           case 1: return "compdl.%0 %1 = %d2, %3";
           case 0:
           case 2:
           case 3: return "compdl.%0 %1 = %d2, %d3";
           default: gcc_unreachable ();
    }
}
[(set_attr "type" "alud_x,alud_x,alud_y,alud_z")
...
(define_insn "*cstoredi4_32bits_symbol"
  [(set (match_operand:SI 1 "register_operand" "=r")
        (match_operator:SI 0 "comparison_operator"
	        [(match_operand:DI 2 "register_operand" "r")
	         (match_operand:DI 3 "nonmemory_operand" "i")]))]
 "!TARGET_64"
 "compdl.%0 %1 = %d2, %d3"
[(set_attr "type" "alud_z")
 (set_attr "length" "16")])
...
(define_insn "*cstoresi4" 
  [(set (match_operand:SI 1 "register_operand" "=r,r,r")
        (match_operator:SI 0 "comparison_operator"
	        [(match_operand:SI 2 "register_operand" "r,r,r")
...
(define_expand "untyped_call"
  ...
  {
    int i;
    rtx reg = gen_rtx_REG (OImode, K1B_ARGUMENT_POINTER_REGNO);
...
(define_insn "div_srs<I:suffix>_k1b"
...
(define_insn "div_srs<I:suffix>_k1a"
  [(set (match_operand:I 0 "register_operand" "=<I:regclass>")
	(div:I (match_operand:I 1 "register_operand" "<I:regclass>")
	       (match_operand 2 "poweroftwo_6bits_immediate_operand" "n")))]
  ""
  ...
  gcc_assert (__builtin_popcount (div) == 1);
  operands[2] = gen_rtx_CONST_INT(VOIDmode, __builtin_ctzl (div));
  return "srs<I:suffix> %<I:suffix>0 = %<I:suffix>1, %2";
}
...
;; PLACEHOLDER for SATD K1B
(define_insn "satd"
  [(set (match_operand:DI 0 "register_operand")
        (unspec:DI [(match_operand:DI 1 "register_operand" )
                    (match_operand:SI 2 "nonmemory_operand" )] UNSPEC_SAT))])

(define_insn "*satd_k1b"
  [(set (match_operand:DI 0 "register_operand" "=r,=r")
...
(define_expand "ssadddi3"
  [(set (match_operand:DI 0 "register_operand")
        (ss_plus:DI (match_operand:DI 1 "register_operand")
                    (match_operand:DI 2 "register_operand")))]
""
{
    if (k1_architecture () >= K1B){
       emit_insn(gen_ssadddi3_k1b(operands[0], operands[1], operands[2]));
    } else {
       emit_insn(gen_ssadddi3_k1a(operands[0], operands[1], operands[2]));
    }
    DONE;
})

(define_insn "ssadddi3_k1a"
  [(set (match_operand:DI 0 "register_operand" "=r")
...
(define_expand "fcomp" 
  [(set (match_operand:SI 0 "register_operand" "=r")
        (match_operator:SI 1 "float_comparison_operator"
...
(define_insn "*fmasf4"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (plus:SF (mult:SF (match_operand:SF 2 "register_operand" "r")
                          (match_operand:SF 3 "register_operand" "r"))
                 (match_operand:SF 1 "register_operand" "r")))]
  ""
  "ffma %0 = %1, %2, %3"
...
(define_insn "*fmadf4"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (plus:DF (mult:DF (match_operand:DF 2 "register_operand" "r")
                          (match_operand:DF 3 "register_operand" "r"))
                 (match_operand:DF 1 "register_operand" "r")))]
  "k1_architecture () >= K1B"
  "ffmad %0 = %1, %2, %3"
...
(define_insn "*ffmarnd"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (plus:DF (mult:DF (unspec:DF [(match_operand:DF 2 "register_operand" "r")] UNSPEC_FPRN)
                          (unspec:DF [(match_operand:DF 3 "register_operand" "r")] UNSPEC_FPRN))
                 (unspec:DF [(match_operand:DF 1 "register_operand" "r")] UNSPEC_FPRN)))]
  "k1_architecture () >= K1B"
  "ffmarnd %0 = %1, %2, %3"
...
(define_insn "*ffmarn"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (plus:SF (mult:SF (unspec:SF [(match_operand:SF 2 "register_operand" "r")] UNSPEC_FPRN)
                          (unspec:SF [(match_operand:SF 3 "register_operand" "r")] UNSPEC_FPRN))
                 (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FPRN)))]
  ""
  "ffmarn %0 = %1, %2, %3"
...
(define_insn "*ffmsnrn"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (minus:SF (mult:SF (unspec:SF [(match_operand:SF 2 "register_operand" "r")] UNSPEC_FPRN)
                           (unspec:SF [(match_operand:SF 3 "register_operand" "r")] UNSPEC_FPRN))
                  (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FPRN)))]
  ""
  "ffmsnrn %0 = %1, %2, %3"
...
(define_insn "*fmsdf4"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (minus:DF (mult:DF (match_operand:DF 2 "register_operand" "r")
                           (match_operand:DF 3 "register_operand" "r"))
                  (match_operand:DF 1 "register_operand" "r")))]
  "k1_architecture () >= K1B"
  "ffmsnd %0 = %1, %2, %3"
...
(define_insn "*ffmsnrnd"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (minus:DF (mult:DF (unspec:DF [(match_operand:DF 2 "register_operand" "r")] UNSPEC_FPRN)
                           (unspec:DF [(match_operand:DF 3 "register_operand" "r")] UNSPEC_FPRN))
                  (unspec:DF [(match_operand:DF 1 "register_operand" "r")] UNSPEC_FPRN)))]
  "k1_architecture () >= K1B"
  "ffmsnrnd %0 = %1, %2, %3"
...
(define_insn "*ffmsrn"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (minus:SF (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FPRN)
                  (mult:SF (unspec:SF [(match_operand:SF 2 "register_operand" "r")] UNSPEC_FPRN)
		           (unspec:SF [(match_operand:SF 3 "register_operand" "r")] UNSPEC_FPRN))))]
  ""
  "ffmsrn %0 = %1, %2, %3"
  [(set_attr "type" "mau_lsu_fpu")
...
(define_expand "fnmadf4"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (minus:DF (match_operand:DF 3 "register_operand" "r")
                  (mult:DF (match_operand:DF 1 "register_operand" "r")
		           (match_operand:DF 2 "register_operand" "r"))))]
  "k1_architecture () >= K1B"
  {}
...
(define_insn "*ffmsrnd"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (minus:DF (unspec:DF [(match_operand:DF 1 "register_operand" "r")] UNSPEC_FPRN)
                  (mult:DF (unspec:DF [(match_operand:DF 2 "register_operand" "r")] UNSPEC_FPRN)
		           (unspec:DF [(match_operand:DF 3 "register_operand" "r")] UNSPEC_FPRN))))]
  "k1_architecture () >= K1B"
  "ffmsrnd %0 = %1, %2, %3"
  [(set_attr "type" "mau_lsu_fpu")
...
(define_insn "*fnmssf4"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (neg:SF (plus:SF (mult:SF (match_operand:SF 2 "register_operand" "r")
                                  (match_operand:SF 3 "register_operand" "r"))
                         (match_operand:SF 1 "register_operand" "r"))))]
  ""
  "ffman %0 = %1, %2, %3"
...
(define_insn "*fnmsdf4"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (neg:DF (plus:DF (mult:DF (match_operand:DF 2 "register_operand" "r")
                                  (match_operand:DF 3 "register_operand" "r"))
                         (match_operand:DF 1 "register_operand" "r"))))]
  "k1_architecture () >= K1B"
  "ffmand %0 = %1, %2, %3"
...
(define_insn "*ffmanrn"
  [(set (match_operand:SF 0 "register_operand" "=r")
        (neg:SF (plus:SF (mult:SF (unspec:SF [(match_operand:SF 2 "register_operand" "r")] UNSPEC_FPRN)
                                  (unspec:SF [(match_operand:SF 3 "register_operand" "r")] UNSPEC_FPRN))
                (unspec:SF [(match_operand:SF 1 "register_operand" "r")] UNSPEC_FPRN))))]
  ""
  "ffmanrn %0 = %1, %2, %3"
...
(define_insn "*ffmanrnd"
  [(set (match_operand:DF 0 "register_operand" "=r")
        (neg:DF (plus:DF (mult:DF (unspec:DF [(match_operand:DF 2 "register_operand" "r")] UNSPEC_FPRN)
                                  (unspec:DF [(match_operand:DF 3 "register_operand" "r")] UNSPEC_FPRN))
                         (unspec:DF [(match_operand:DF 1 "register_operand" "r")] UNSPEC_FPRN))))]
  "k1_architecture () >= K1B"
  "ffmanrnd %0 = %1, %2, %3"
...
(define_insn "*fmuln"
  ...
  ""
  "fmuln %0 = %1, %2"
[(set (attr "type") (cond [(match_test "k1_architecture() >= K1B") (const_string "mau_fpu")] (const_string "mau_lsu_fpu")))
 (set_attr "length" "4")]
)
...
[(set (attr "type") (cond [(match_test "k1_architecture() >= K1B") (const_string "mau_fpu")] (const_string "<F:sched>")))
 (set_attr "length" "4")]
)
...
[(set (attr "type") (cond [(match_test "k1_architecture() >= K1B") (const_string "mau_fpu")] (const_string "<I:sched>")))
 (set_attr "length" "4")]
)
...
;; (define_insn "*abd_k1b"
;;   [(set (match_operand:SI 0 "register_operand" "=r")
;; 	(abs:SI (minus:SI  (match_operand:SI 2 "nonmemory_operand" "r")
;; 	                   (match_operand:SI 1 "register_operand" "r"))))]
;;   "k1_architecture () >= K1B"
;;   "abd %0 = %1, %2"
;;   [(set_attr "type" "alu")
...
(define_insn "*abdd_k1b"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(abs:DI (minus:DI  (match_operand:DI 2 "nonmemory_operand" "r")
		           (match_operand:DI 1 "register_operand" "r"))))]
  "k1_architecture () >= K1B"
  "abdd %0 = %1, %2"
[(set_attr "type" "alud_lite")
  ...
  ""
{
	if (k1_architecture() < K1B){
	    ...
	    emit_insn (gen_addv2hi3 (gen_lowpart (V2HImode, operands[0]),
 	                             gen_lowpart (V2HImode, operands[1]),
                                     gen_lowpart (V2HImode, operands[2])));
            emit_insn (gen_addv2hi3 (gen_highpart (V2HImode, operands[0]),
	                             gen_highpart (V2HImode, operands[1]),
                                     gen_highpart (V2HImode, operands[2])));
            DONE;
        }
...
{
        if (k1_architecture() >= K1B){
	    emit_insn(gen_ssaddv4hi3_k1b(operands[0], operands[1], operands[2]));
	} else {
        if (!reg_mentioned_p (operands[0], operands[1])
            && !reg_mentioned_p (operands[0], operands[2]))
                emit_insn (gen_rtx_CLOBBER (V4HImode, operands[0]));

	emit_insn (gen_ssaddv2hi3 (gen_lowpart (V2HImode, operands[0]),
 			           gen_lowpart (V2HImode, operands[1]),
                                   gen_lowpart (V2HImode, operands[2])));
	emit_insn (gen_ssaddv2hi3 (gen_highpart (V2HImode, operands[0]),
		     	           gen_highpart (V2HImode, operands[1]),
 			           gen_highpart (V2HImode, operands[2])));
	}
	DONE;
...
(define_expand "addv2si3"
  [(set (match_operand:V2SI 0 "register_operand" )
	(plus:V2SI (match_operand:V2SI 1 "register_operand" )
		   (match_operand:V2SI 2 "register_operand" )))]
  ""
{
	if (k1_architecture() >= K1B) {
	   emit_insn(gen_addv2si3_k1b(operands[0], operands[1], operands[2]));
	} else {
	...
	emit_insn (gen_addsi3 (gen_lowpart (SImode, operands[0]),
		  	       gen_lowpart (SImode, operands[1]),
		  	       gen_lowpart (SImode, operands[2])));
	emit_insn (gen_addsi3 (gen_highpart (SImode, operands[0]),
		  	       gen_highpart (SImode, operands[1]),
		  	       gen_highpart (SImode, operands[2])));
        }
	DONE;

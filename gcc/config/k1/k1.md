...
(define_expand "avgsi3_floor"
  ...
  ""
  {
    ...
    emit_insn (gen_k1_avgw (result, operands[1], operands[2]));
    operands[0] = gen_rtx_SIGN_EXTEND (SImode, result);
  }
)
...
(define_expand "uavgsi3_floor"
  ...
  {
    rtx result = gen_reg_rtx (SImode);
    emit_insn (gen_k1_avguw (result, operands[1], operands[2]));
    operands[0] = gen_rtx_ZERO_EXTEND (SImode, result);
  }
)
...
(define_expand "avgsi3_ceil"
  ...
  {
    rtx result = gen_reg_rtx (SImode);
    emit_insn (gen_k1_avgrw (result, operands[1], operands[2]));
    operands[0] = gen_rtx_SIGN_EXTEND (SImode, result);
  }
)
...
(define_expand "uavgsi3_ceil"
  ...
  {
    rtx result = gen_reg_rtx (SImode);
    emit_insn (gen_k1_avgruw (result, operands[1], operands[2]));
    operands[0] = gen_rtx_ZERO_EXTEND (SImode, result);
  }
)

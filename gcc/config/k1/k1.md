...
(define_insn "*l<SHORT:lsusize><su><code>"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		...
		(match_dup 1)))]
  "!K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><su>.<SIDI:cbvar><code>z %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])

(define_insn "*l<SHORT:lsusize><su><code>_uncached"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		(cb_cond (match_operand:SIDI 0 "register_operand" "r")
		         (const_int 0))
		...
		(match_dup 1)))]
  "K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><su>.u.<SIDI:cbvar><code>z %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load_uncached")])

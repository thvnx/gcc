...
;;      }
;;    }
;;  [(set_attr "type" "lsu_store, lsu_store_x, lsu_store_uncached, lsu_store_uncached_x,
...
(define_insn "*lq_multiple"
  ...
  ""
  {
    k1_output_load_multiple(operands);
    return \"\";
  }
...
(define_insn "addcd"
  ...
  "k1_isa_filter_enabled_p(K1_ISA_ALU_FULL_ODD, NULL)"
  "addcd %0 = %1, %2"
...
(define_insn "adddi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(plus:DI (match_operand:DI 1 "register_operand" "r,r,r,r")
		 (match_operand:DI 2 "register_s64_operand" "r,I10,I37,n")))]
""
"addd %0 = %1, %2"
...
(define_insn "*subsi3_zext"
  ...
  ""
  "sbfw %0 = %1, %2"
[(set_attr "type" "tiny,tiny_x,tiny_y")
 (set_attr "length" "4,8,12")])

(define_insn "subdi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(minus:DI (match_operand:DI 1 "register_s64_operand" "r,I10,I37,n")
...
(define_insn "mulsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	(mult:SI (match_operand:SI 1 "register_operand" "r,r,r")
		 (match_operand:SI 2 "register_s37_operand" "r,I10,I37")))]
  "k1_isa_filter_enabled_p(K1_ISA_MAU, NULL)"
  "mulwd %0 = %1, %2"
...
;;         emit_insn (gen_madduciwd (tmp1, gen_highpart(SImode, operands[1]), gen_lowpart(SImode, operands[2])));
...
;; FIXME AUTO: Disabling bunch of MAU as it's subject to change. Let gcc emit subopt asm for the moment.
...
;;                           (match_operand:DI 2 "immediate_operand" "J10,G37,i"))
...
;;                   (mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" ""))
;;                            (match_operand:DI 2 "register_s37_operand" ""))))]
;; ""
;; {
;;   if(!CONST_INT_P(operands[2])) {
;;     operands[2] = gen_rtx_SIGN_EXTEND(DImode, operands[2]);
...
;; (define_insn "*msubsidi4_imm"
;;   [(set (match_operand:DI 0 "register_operand" "=r,r")
;;         (minus:DI (match_operand:DI 3 "register_operand" "0,0")
;;                   (mult:DI (sign_extend:DI (match_operand:SI 1 "register_operand" "r,r"))
;;                            (match_operand:DI 2 "s37_operand" "I10,I37"))))]
;; ""
;; "msbfwd %0 = %1, %2"
;; [(set_attr "type" "mau_acc,mau_acc_x")
;;  (set_attr "length" "4,8")])
...
;;         (minus:DI (match_operand:DI 3 "register_operand" "")
;;                   (mult:DI (zero_extend:DI (match_operand:SI 1 "register_operand" ""))
;;                            (match_operand:DI 2 "reg_or_unsigned_mul_immediate_37" ""))))]
;; ""
;; {
;;   if(!CONST_INT_P(operands[2])) {
;;     operands[2] = gen_rtx_ZERO_EXTEND(DImode, operands[2]);
...
;;  (set_attr "length" "4")]
;; )
;; (define_insn "*umsubsidi4_imm"
;;   [(set (match_operand:DI 0 "register_operand" "+r,r")
;;         (minus:DI (match_operand:DI 3 "register_operand" "0,0")
;;                   (mult:DI (zero_extend:DI (match_operand:SI 1 "register_operand" "r,r"))
;;                            (match_operand 2 "unsigned_mul_immediate_37" "J10,U37"))))]
;; ""
;; "msbfuwd %0 = %1, %2"
;; [(set_attr "type" "mau_acc")
;;  (set_attr "length" "4")]
...
[(set (match_operand:SI 0 "register_operand" )
  ...
  "k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
{
...
(define_insn "syncgroup"
   [(unspec_volatile [(match_operand:SI 0 "register_operand" "r")] UNSPEC_SYNCGROUP)
...
(define_insn "*l<mode><lsext>"
   ...
   ""
   {
     ...
     case 0:
     case 1:
       return "l<ALL_SMALL_I:lsusize><lsext>%m1 %0 = %1";
     case 2:
     case 3:
       return "l<ALL_SMALL_I:lsusize><lsext>.u%m1 %0 = %1";
     default: gcc_unreachable ();
     }
   }
[(set_attr "length" "4,8,4,8")
...
;; FIXME AUTO: add size info for 'reg[reg]' addressing (currently falling back to lsu.x)
;;  (define_insn "*l<mode><lsext>_uncached"
;;     [(set (match_operand:DI 0 "register_operand" "=r,r")
;;           (ANY_EXTEND:DI (match_operand:ALL_SMALL_I 1 "memory_operand" "a,m")))]
;;     "K1_FORCE_UNCACHED_LSU"
;;     "l<ALL_SMALL_I:lsusize><lsext>u%m1 %0 = %1"
;;  [(set_attr "length" "4,8")
...
(define_insn "sbmm8"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r,r,r,r")
		    (match_operand:DI 2 "register_s64_operand" "r,I10,I37,n")] UNSPEC_SBMM8))]
"k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
"sbmm8 %0 = %1, %2"
...
(define_insn "sbmmt8"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r,r,r,r")
		    (match_operand:DI 2 "register_s64_operand" "r,I10,I37,n")] UNSPEC_SBMMT8))]
"k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
"sbmmt8 %0 = %1, %2"
[(set_attr "type" "lite,lite,lite_x,lite_y")
 (set_attr "length" "4,4,8,12")])
...
(define_insn "bwluwp"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(unspec:DI [(match_operand:DI 1 "register_operand" "r")
		    (match_operand:DI 2 "register_operand" "r")
		    (match_operand 3 "const_int_operand" "n")] UNSPEC_BWLUWP))]
  "k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
  "bwluwp %0 = %1, %2, %u3"
  	...
  	(if_then_else:ALLI
		(cb_cond (match_operand:SIDI 0 "register_operand" "r")
 		...
 		(mem:ALLI (match_operand:P 2 "register_operand" "r"))
               (match_dup 1)))]
  "!K1_FORCE_UNCACHED_LSU"
  "l<ALLI:lsusize><lsusext>.<SIDI:cbvar><code>z %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])
...
(define_insn "*l<ALLI:lsusize><code>_uncached"
  [(set (match_operand:ALLI 1 "register_operand" "+r")
  	(if_then_else:ALLI
		...
		(match_dup 1)))]
 "K1_FORCE_UNCACHED_LSU"
 "l<ALLI:lsusize><lsusext>.u.<SIDI:cbvar><code>z %0 ? %1 = [%2]"
...
(define_insn "*l<ALLI:lsusize>_<lsu_odd_even>"
   [(set (match_operand:ALLI 1 "register_operand" "+r")
		...
		(match_dup 1)))]
  "!K1_FORCE_UNCACHED_LSU"
  "l<ALLI:lsusize><lsusext>.<lsu_odd_even> %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])

(define_insn "*l<ALLI:lsusize>_<lsu_odd_even>_uncached"
  [(set (match_operand:ALLI 1 "register_operand" "+r")
  	(if_then_else:ALLI
		(COND_ODD_EVEN (zero_extract (match_operand:SI 0 "register_operand" "r")
			         (const_int 1) (const_int 0))
		...
		(match_dup 1)))]
  "K1_FORCE_UNCACHED_LSU"
  "l<ALLI:lsusize><lsusext>.u.<lsu_odd_even> %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])

;; matching sign/zero extend loads.
(define_insn "*l<SHORT:lsusize><lsext><cb_cond:code>"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		...
		(match_dup 1)))]
  "!K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><lsext>.<SIDI:cbvar><cb_cond:code>z %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])

(define_insn "*l<SHORT:lsusize><lsext><cb_cond:code>_uncached"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		(cb_cond (match_operand:SIDI 0 "register_operand" "r")
		         (const_int 0))
		...
		(match_dup 1)))]
  "K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><lsext>.u.<SIDI:cbvar><cb_cond:code>z %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load_uncached")])

(define_insn "*l<SHORT:lsusize><lsext>_<lsu_odd_even>"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		...
		(match_dup 1)))]
  "!K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><lsext>.<lsu_odd_even> %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load")])

(define_insn "*l<SHORT:lsusize><lsext>_<lsu_odd_even>_uncached"
  [(set (match_operand:DI 1 "register_operand" "+r")
  	(if_then_else:DI
		(COND_ODD_EVEN (zero_extract (match_operand:SIDI 0 "register_operand" "r")
			       (const_int 1) (const_int 0))
		...
		(match_dup 1)))]
  "K1_FORCE_UNCACHED_LSU"
  "l<SHORT:lsusize><lsext>.u.<lsu_odd_even> %0 ? %1 = [%2]"
  [(set_attr "type" "lsu_load_uncached")])
...
(define_insn "abssf2"
  ...
  "k1_isa_filter_enabled_p(K1_ISA_ALU_FULL, NULL)"
  "fabsw %0 = %1"
[(set_attr "type" "alu")]
)
...
(define_insn "builtin_extendhfsf2"
  [(set (match_operand:SF 0 "register_operand" "=r")
	(unspec:SF [(match_operand:SI 1 "register_operand" "r")] UNSPEC_FWIDENHBW))]
  "k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
  "fwidenhbw %0 = %1"
[(set_attr "type" "lite")])
...
;; 	(unspec:V2SF [(match_operand:DI 1 "register_operand" "r")] UNSPEC_FWIDENHLWP))]
;;   ""
;;   "fwidenlwp %0 = %1"
;; [(set_attr "type" "alud")
;;  (set_attr "length" "4")]
...
(define_insn "builtin_extendhfsf2_tophalf"
  [(set (match_operand:SF 0 "register_operand" "=r")
	(unspec:SF [(match_operand:SI 1 "register_operand" "r")] UNSPEC_FWIDENHTW))]
  "k1_isa_filter_enabled_p(K1_ISA_ALU_LITE, NULL)"
  "fwidenhtw %0 = %1"
[(set_attr "type" "lite")])
...
;;   [(set (match_operand:V2SF 0 "register_operand" "=r")
;; 	(unspec:V2SF [(match_operand:DI 1 "register_operand" "r")] UNSPEC_FWIDENHMWP))]
;;   ""
;;   "fwidenhmwp %0 = %1"
;; [(set_attr "type" "alud")
;;  (set_attr "length" "4")]
...
(define_insn "mulsf3"
  [(set (match_operand:SF 0 "register_operand" "=r")
	(mult:SF (match_operand:SF 1 "register_operand" "r")
		 (match_operand:SF 2 "register_operand" "r")))]
  "k1_isa_filter_enabled_p(K1_ISA_MAU_FPU, NULL)"
  "fmulw %0 = %1, %2"
...
(define_expand "smindf3"
  [(set (match_operand:DF 0 "register_operand" "")
	(smin:DF (match_operand:DF 1 "register_operand" "")
		 (match_operand:DF 2 "register_operand" "")))]
  "k1_isa_filter_enabled_p(K1_ISA_ALU_FULL, NULL)"
  {}
)
...
(define_expand "smaxdf3"
  [(set (match_operand:DF 0 "register_operand" "")
	(smax:DF (match_operand:DF 1 "register_operand" "")
		 (match_operand:DF 2 "register_operand" "")))]
  "k1_isa_filter_enabled_p(K1_ISA_ALU_FULL, NULL)"
  {}
)
...
(define_expand "fixed<I:sfx>" 
  [(set (match_operand:I 0 "register_operand" "")
	(unspec:I [(match_operand:SI 1 "twobits_unsigned_operand" "")

...
(define_expand "umulsidi3"
  [(set (match_operand:DI 0 "register_operand" )
	(mult:DI (zero_extend:DI (match_operand:SI 1 "register_operand" ))
		 (match_operand 2 "register_or_u32immediate" )))]
  "k1_isa_filter_enabled_p(K1_ISA_MAU, NULL)"
{
   if(!CONST_INT_P(operands[2])) {
...
(define_insn "madd<mode><mode>4"
  [(set (match_operand:SIDI 0 "register_operand" "=r,r,r")
        (plus:SIDI (mult:SIDI (match_operand:SIDI 1 "register_operand" "r,r,r")
                              (match_operand:SIDI 2 "nonmemory_operand" "r,B32,i"))
...
(define_insn "*<ssfx>msubsidi4_reg"
  [(set (match_operand:DI 0 "register_operand" "=r")
        (minus:DI (match_operand:DI 3 "register_operand" "r")
                  (mult:DI (ANY_EXTEND:DI (match_operand:SI 1 "register_operand" "r"))
                           (ANY_EXTEND:DI (match_operand:SI 2 "register_operand" "r")))))]
  "k1_isa_filter_enabled_p(K1_ISA_MAU, NULL)"
  "msbf<ssfx>wd %0 = %3, %1, %2"
[(set_attr "type" "mau_acc")
 (set_attr "length" "4")])

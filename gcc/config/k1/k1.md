...
;; move imm to reg
(define_insn "*mov<mode>_immint_k1c"
   [(set (match_operand:ALLI 0 "register_operand"    "= r  , r  , r, r")
         (match_operand:ALLI 1 "k1_make_int_operand" "  I16, I43, i, S"))]
   ""
   "make %0 = %1"
   [(set_attr "type" "tiny, tiny_x, tiny_y, tiny_y")
    (set_attr "length" "4, 8, 12, 12")]
)

(define_insn "*mov<mode>_immfloat_k1c"
   [(set (match_operand:ALLF 0 "register_operand"  "=r  , r  , r")
         (match_operand:ALLF 1 "k1_make_float_operand" "H16, H43, F"))]
   ""
   "make %0 = %1"

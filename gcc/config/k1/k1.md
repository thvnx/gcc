...
(define_insn "subdi3"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
	(minus:DI (match_operand:DI 1 "register_operand" "r,r,r,r")
 		  (match_operand:DI 2 "nonmemory_operand" "r,I10,D37,i")))]
  ""
  "sbfd %0 = %2, %1"
[(set_attr "type" "tiny,tiny,tiny_x,tiny_y")
...
(define_insn "fma<mode>4"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (match_operand:F 1 "register_operand" "r")
	        (match_operand:F 2 "register_operand" "r")
	        (match_operand:F 3 "register_operand" "0")))]
  ""
  "ffma<F:sfx> %0 = %1, %2"
  [(set_attr "type" "mau_acc")
   (set_attr "length" "4")]
...
(define_insn "ffma<F:fmasfx>rn"
  [(set (match_operand:F 0 "register_operand" "=r")
        (plus:F (mult:F (unspec:F [(match_operand:F 1 "register_operand" "r")] UNSPEC_FPRN)
                        (unspec:F [(match_operand:F 2 "register_operand" "r")] UNSPEC_FPRN))
                (unspec:F [(match_operand:F 3 "register_operand" "0")] UNSPEC_FPRN)))]
  ""
  "ffma<F:fmasfx>rn %0 = %1, %2"
...
(define_insn "fms<mode>4"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (match_operand:F 1 "register_operand" "r")
	        (match_operand:F 2 "register_operand" "r")
	        (neg:F (match_operand:F 3 "register_operand" "0"))))]
  ""
  "ffmsn<F:sfx> %0 = %1, %2"
  [(set_attr "type" "mau_lsu_fpu")
   (set_attr "length" "4")]
...
(define_insn "ffmsn<F:fmasfx>rn"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (unspec:F [(match_operand:F 1 "register_operand" "r")] UNSPEC_FPRN)
	        (unspec:F [(match_operand:F 2 "register_operand" "r")] UNSPEC_FPRN)
	        (neg:F (unspec:F [(match_operand:F 3 "register_operand" "0")] UNSPEC_FPRN))))]

  ""
  "ffmsn<F:fmasfx>rn %0 = %1, %2"
  [(set_attr "type" "mau_lsu_fpu")
   (set_attr "length" "4")]
)
...
(define_insn "fnma<mode>4"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (neg:F (match_operand:F 1 "register_operand" "r"))
	        (match_operand:F 2 "register_operand" "r")
	        (match_operand:F 3 "register_operand" "0")))]
  ""
  "ffms<F:sfx> %0 = %1, %2"
...
(define_insn "ffms<F:fmasfx>rn"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (neg:F (unspec:F [(match_operand:F 1 "register_operand" "r")] UNSPEC_FPRN))
	        (unspec:F [(match_operand:F 2 "register_operand" "r")] UNSPEC_FPRN)
	        (unspec:F [(match_operand:F 3 "register_operand" "0")] UNSPEC_FPRN)))]
  ""
  "ffms<F:fmasfx>rn %0 = %1, %2"
  [(set_attr "type" "mau_lsu_fpu")
   (set_attr "length" "4")]
)
...
(define_insn "ffman<F:fmasfx>rn"
  [(set (match_operand:F 0 "register_operand" "=r")
        (fma:F  (neg:F (unspec:DF [(match_operand:F 1 "register_operand" "r")] UNSPEC_FPRN))
	        (unspec:DF [(match_operand:F 2 "register_operand" "r")] UNSPEC_FPRN)
	        (neg:F (unspec:DF [(match_operand:F 3 "register_operand" "0")] UNSPEC_FPRN))))]

  ""
  "ffman<F:fmasfx>rn %0 = %1, %2"
  [(set_attr "type" "mau_lsu_fpu")
   (set_attr "length" "4")]
)

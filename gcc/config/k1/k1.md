...
(define_insn "*mov<mode>_reg_k1c"
   [(set (match_operand:ALLI 0 "register_operand"  "=r, r  , r,   r")
         (match_operand:ALLI 1 "nonmemory_operand" " r, I16, I43, i"))]
   ""
{
...
[(set_attr "type" "tiny,tiny,tiny_x,tiny_x")
 (set_attr "length" "4,4,8,16")]
)


(define_insn "*mov<mode>_memcached_k1c"
   [(set (match_operand:ALLI 0 "nonimmediate_operand" "=r, r, a, m")
         (match_operand:ALLI 1 "nonimmediate_operand" " a, m, r, r"))]

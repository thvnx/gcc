...
;; standard pattern  DO NOT use force_reg in every case (see mov<m> doc 16.9 [1])
...
;; move imm to reg
(define_insn "*mov<mode>_imm_k1c"
   [(set (match_operand:ALLIF 0 "register_operand"  "= r  , r  , r  , r  , r, r")
         (match_operand:ALLIF 1 "immediate_operand" "  I16, H16, I43, H43, i, F"))]
   ""
   "make %0 = %1"
   [(set_attr "type" "tiny, tiny, tiny_x, tiny_x, tiny_y, tiny_y")
    (set_attr "length" "4, 4, 8, 8, 12, 12")]
)

;; move reg to mem
(define_insn "*mov<mode>_store_k1c"
   [(set (match_operand:ALLIF 0 "memory_operand"    "= a, m")
         (match_operand:ALLIF 1 "register_operand"  "  r, r"))]
   ""
   "s<lsusize>%m0 %0 = %1"
...
;; move mem to reg
(define_insn "*mov<mode>_load_k1c"
   [(set (match_operand:ALLIF 0 "register_operand" "= r , r , r , r ")
         (match_operand:ALLIF 1 "memory_operand"   "  Ca, Cm, Za, Zm"))]
   ""
   "l<lsusize><lsusext>%C1%m1 %0 = %1"
   [(set_attr "type" "lsu_load, lsu_load_x, lsu_load_uncached, lsu_load_uncached_x")
    (set_attr "length" "4, 8, 4, 8")]
)

;; move reg to reg  DO NOT remove last constraints as they are use during
;;                  reload of paradoxical subregs that didn't get hard
;;                  registers (they are replaced with a stack slot) (see [2])
(define_insn "*movi<mode>_reg_k1c"
   [(set (match_operand:ALLIF 0 "register_operand"  "= r,  RXX, r, r, r, a, m")
         (match_operand:ALLIF 1 "register_operand"  "  RXX, r,  r, a, m, r, r"))]
   ""
   "@
    get %0 = %1
    set %0 = %1
    copyd %0 = %1
    l<lsusize><lsusext>%m1 %0 = %1
    l<lsusize><lsusext>%m1 %0 = %1
    s<lsusize>%m0 %0 = %1
    s<lsusize>%m0 %0 = %1"
   [(set_attr "type" "bcu_get, bcu, tiny, lsu_load, lsu_load_x, lsu_store, lsu_store_x")
...
;; PIC dedicated patterns
(define_insn "*mov<mode>_got"
   [(set (match_operand:SIDI 0 "register_operand"  "=r")
         (unspec:SIDI [(match_operand:SIDI 1)] UNSPEC_GOT))]
   ""
   "make %0 = @got(%1)"
[(set_attr "type" "tiny_x")
 (set_attr "length" "8")])

(define_insn "*mov<mode>_gotoff"
   [(set (match_operand:SIDI 0 "register_operand"  "=r")
         (unspec:SIDI [(match_operand:SIDI 1)] UNSPEC_GOTOFF))]
   ""
   "make %0 = @gotoff(%1)"
[(set_attr "type" "tiny_x")
 (set_attr "length" "8")])

(define_insn "*add<mode>3_gotoff"
  [(set (match_operand:SIDI 0 "register_operand" "=r")
	(plus:SIDI (match_operand:SIDI 1 "register_operand" "r")
                   (unspec:SIDI [(match_operand:SIDI 2)] UNSPEC_GOTOFF) ))]

  ""
  "add<SIDI:suffix> %0 = %1, @gotoff(%2)"
[(set_attr "type" "tiny_x")
 (set_attr "length" "8")])

(define_insn "*add<mode>3_got"
  [(set (match_operand:SIDI 0 "register_operand" "=r")
	(plus:SIDI (match_operand:SIDI 1 "register_operand" "r")
                   (unspec:SIDI [(match_operand:SIDI 2)] UNSPEC_GOT) ))]

  ""
  "add<SIDI:suffix> %0 = %1, @got(%2)"
[(set_attr "type" "tiny_x")
 (set_attr "length" "8")])
...
(define_insn "*nandd"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
        (ior:DI (not:DI (match_operand:DI 1 "register_operand" "r,r,r,r"))
                (not:DI (match_operand:DI 2 "nonmemory_operand" "r,I10,B37,i"))))]
  ""
  "nandd %0 = %1, %2"
[(set_attr "type" "tiny,tiny,tiny_x,tiny_y")
 (set_attr "length" "4,4,8,12")]
...
(define_insn "*nxord"
  [(set (match_operand:DI 0 "register_operand" "=r,r,r,r")
        (not:DI (xor:DI (match_operand:DI 1 "register_operand" "r,r,r,r")
                (match_operand:DI 2 "register_operand" "r,I10,B37,i"))))]
  ""
  "nxord %0 = %1, %2"
[(set_attr "type" "tiny,tiny,tiny_x,tiny_y")
 (set_attr "length" "4,4,8,12")]
...
(define_insn "add_pcrel_<mode>"
  [(set (match_operand 0 "pmode_register_operand" "=r,r,r")
	(plus:P (reg:P PC_REGNO)
                (match_operand:P 1 "nonmemory_operand" "I16,I43,i")))]
 ""
 "pcrel %0 = %1"
[(set_attr "type" "alu,alu_x,alu_y")
 (set_attr "length" "4,8,12")])

;; FIXME AUTO: This iterator and pattern should be removed
(define_mode_attr suffixbits [(SI "") (DI "64")])
(define_insn "set_gotp_<mode>"
   [(set (match_operand:P 0 "register_operand" "=r")
         (unspec_volatile:P [(const_int 0)] UNSPEC_PIC))]
   ""
   "pcrel %0 = @gotaddr()"
[(set_attr "type" "alu_x")
 (set_attr "length" "8")]
...
(define_insn "acswap<lsusize>"
    [(set (match_operand:TI 0 "register_operand" "+r,r")
          (unspec:TI [(match_operand:SIDI 1 "memory_operand" "+a,m")] UNSPEC_ACSWAP))
     (set (match_dup 1)
          (unspec:SIDI
           [(match_dup 1)
            (match_dup 0)]
...
(define_insn "*l<mode><lsext>"
   ...
   ""
   "l<ALL_SMALL_I:lsusize><lsext>%C1%m1 %0 = %1"
[(set_attr "length" "4,8,4,8")
 (set_attr "type" "lsu_load,lsu_load_x,lsu_load_uncached,lsu_load_uncached_x")]
)
...
;; =========================== References ===============================
;;
;; [1] GCC Internals - Machine Description
;;     https://gcc.gnu.org/onlinedocs/gcc-4.9.4/gccint/Standard-Names.html#Standard-Names
;;
;; [2] GCC Mailing List - Paradoxical subreg questions
;;     https://gcc.gnu.org/ml/gcc/2000-01/msg00426.html

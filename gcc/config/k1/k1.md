  ...
  "
{
  ...
  if (GET_CODE (operands[2]) != CONST_INT
      ...
      || REGNO (operands[1]) > K1C_GPR_LAST_REGNO)
    FAIL;
...
(define_insn "*<ssfx>mulsidi3_imm"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(mult:DI (ANY_EXTEND:DI (match_operand:SI 1 "register_operand" "r"))
		 (match_operand:SI 2 "k1_imm_<lsext>32_pic_operand" "i")))]
  ""
  "mul<ssfx>wd %0 = %1, %2"
[(set_attr "type" "mau_x")
 (set_attr "length" "8")])
...
(define_insn "*usmulsidi3_imm"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(mult:DI (match_operand:SI 1 "k1_imm_s32_pic_operand" "i")

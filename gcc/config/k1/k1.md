...
(define_insn "*mov<mode>_all"
    [(set (match_operand:ALLIF 0 "nonimmediate_operand" "=r ,         r,  r, a, m, r , r , r , r , r,  RXX, r")
          (match_operand:ALLIF 1 "general_operand"      "I16H16, I43H43, nF, r, r, Ca, Cm, Za, Zm, RXX,  r, S"))]
...
[(set_attr "type"    "tiny, tiny_x, tiny_y, lsu_store, lsu_store_x, lsu_load, lsu_load_x, lsu_load_uncached, lsu_load_uncached_x, bcu_get, bcu, tiny<symlen1>")
 (set_attr "length"  "4,         8,     12,         4,           8,        4,          8,                 4,                   8,       4,   4, <symlen2>")
 (set (attr "disabled")
      (cond [(and (eq_attr "alternative" "11")

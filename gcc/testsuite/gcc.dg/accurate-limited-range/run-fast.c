/* { dg-do run } */
/* { dg-options "-fcx-limited-range -fcx-accurate-limited-range=fast -ffp-contract=off" } */
...
static s_cplx const refmul [] = {
  ...
  { .x=0x1.eddcf8d3d974p+124 + -0x1.f3791bd7d2241p+44 * I, .y=-0x1.d2213fc92eeafp+31 + -0x1.4c55a371cdc42p-48 * I, .z=-0x1.c19e30bd99b15p+156 + -0x1.74cc3d026dba7p+75 * I },
  { .x=0x1.0839eeedadd69p-100 + 0x1.8fad9e6227da7p+25 * I, .y=0x1.71e81eb57a674p-200 + -0x1.5900ed142c108p-74 * I, .z=0x1.0d51364ac0d92p-48 + -0x1.0d54d199aa469p-176 * I },
  { .x=0x1.f8e31dda2563p-56 + -0x1.fefb0a075a71dp-184 * I, .y=-0x1.526893b79061dp-236 + -0x1.44320f4637dd3p-364 * I, .z=-0x1.4db50e814b9d9p-291 + 0x1.20b01e74eed23p-423 * I },
  ...
  { .x=-0x1.1e0f62ceba167p-186 + 0x1.cf9f4c1074f21p-734 * I, .y=-0x1.ecead5be6b8b5p-174 + -0x1.e1429775b6778p-720 * I, .z=0x1.1365fd6699b35p-359 + 0x1.3a9975a39ddfap-906 * I }
} ;
